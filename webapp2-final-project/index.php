...
// DSN (Data Source Name) specifying the database connection details
$dsn = "mysql:host=$host;dbname=$db;charset=UTF8";
// PDO options to set error mode to exception for better error handling
...
try {
    ...
    if ($pdo && $_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        if (!empty($_POST['username']) && !empty($_POST['password'])) {
            ...
            // Prepare an SQL query to fetch the user by username
            ...
            if ($user) {
              if ('qwertyuiop' === $password) {
                ...
                $error_message = $user ? 'Invalid password!' : "Cannot find user {$username}!";
            }
        } else {
...
<body>
  <div id="Container">  
    <form id="loginForm" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
      ...
      ?>
        <input class="form-content" type="text" name="username" placeholder="Enter Username" id="username" required />
        <input class="form-content" type="password" name="password" placeholder="Enter Password" id="password" required />
